 ...
 * @return {itemSheet: Jimp, itemData: Map<string, Object>} Item spritesheet and metadata.
 * @memberof module:lib/factorio
 * @private
 * @inner
 */
 ...
 * @param modVersions {Map<string, string>} modVersions -
 *     Mapping of mod name to version to export locale from.
 * @param modOrder {Array<string>} modOrder - Load order of the mods.
...
async function exportData(server) {
	...
	await fs.outputFile("temp/export.zip", content);
}
