...
export class ControllerConfig extends classes.Config<ControllerConfigFields> {
	...
	static fieldDefinitions: classes.ConfigDefs<ControllerConfigFields> = {
		...
		"controller.mods_directory": {
			...
			type: "string",
			initialValue: "mods",
			extendedValidation: validate.filePath,
		},
		...
		"controller.autosave_interval": {
			...
			type: "number",
			initialValue: 60,
			extendedValidation: validate.greaterThanZero,
		},
		"controller.http_port": {
			...
			optional: true,
			initialValue: 8080,
			extendedValidation: validate.optional(validate.all(
				validate.integer,
		...
		"controller.tls_certificate": {
			...
			type: "string",
			optional: true,
			extendedValidation: validate.optional(validate.filePath),
		},
		...
		"controller.mod_portal_cache_duration_minutes": {
			...
			type: "number",
			initialValue: 30,
			extendedValidation: validate.greaterThanEqualZero, // Zero is allowed here to disable cache
		},
...
export class InstanceConfig extends classes.Config<InstanceConfigFields> {
	...
	static fieldDefinitions: classes.ConfigDefs<InstanceConfigFields> = {
		...
		"factorio.shutdown_timeout": {
			...
			type: "number",
			initialValue: 300,
			extendedValidation: validate.greaterThanEqualZero,
		},
		"factorio.game_port": {
			...
			type: "number",
			optional: true,
			extendedValidation: validate.optional(validate.greaterThanZero),
		},
