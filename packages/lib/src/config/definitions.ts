...
export class ControllerConfig extends classes.Config<ControllerConfigFields> {
	...
	static fieldDefinitions: classes.ConfigDefs<ControllerConfigFields> = {
		...
		"controller.mods_directory": {
			...
			type: "string",
			initialValue: "mods",
			extendedValidation: validators.filePath,
		},
		...
		"controller.autosave_interval": {
			...
			type: "number",
			initialValue: 60,
			extendedValidation: validators.greaterThanZero,
		},
		"controller.http_port": {
			...
			optional: true,
			initialValue: 8080,
			extendedValidation: validators.optional(validators.all(
				validators.integer,
		...
		"controller.tls_certificate": {
			...
			type: "string",
			optional: true,
			extendedValidation: validators.optional(validators.filePath),
		},
		...
		"controller.mod_portal_cache_duration_minutes": {
			...
			type: "number",
			initialValue: 30,
			extendedValidation: validators.greaterThanEqualZero, // Zero is allowed here to disable cache
		},
...
export class InstanceConfig extends classes.Config<InstanceConfigFields> {
	...
	static fieldDefinitions: classes.ConfigDefs<InstanceConfigFields> = {
		...
		"factorio.version": {
			...
			extendedValidation: function(value) {
		...
		"factorio.shutdown_timeout": {
			...
			type: "number",
			initialValue: 300,
			extendedValidation: validators.greaterThanEqualZero,
		},
		"factorio.game_port": {
			...
			type: "number",
			optional: true,
			extendedValidation: validators.optional(validators.greaterThanZero),
		},
