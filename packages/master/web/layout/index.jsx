			...
			<Layout style={{ minHeight: "100vh" }}>
				...
				<Layout style={{
					...
					>
						...
						<Route exact path="/instances" component={InstancesTable} />
						<Route exact path="/instances/:id/view" component={InstanceView} />
						<Route exact path="/slaves" component={SlavesTable} />
						<Route exact path="/slaves/:id/view" component={SlavesTable} />
